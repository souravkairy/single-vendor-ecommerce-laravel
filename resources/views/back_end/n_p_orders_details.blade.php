...
<section class="wrapper site-min-height">
          ...
          <div class="col-lg-12">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
              <div class="custom-box">
                ...
                @if ($order_tbl->status == 5 )
                     <a class="btn btn-theme" href="{{ url('p_accepted/'.$order_tbl->order_id) }}">Accept Return Order Cancel</a>
                 <a class="btn btn-danger" href="{{ url('cancel_orders/'.$order_tbl->order_id) }}">Cancel Order</a>
                @else

                <a class="btn btn-theme" href="{{ url('p_accepted/'.$order_tbl->order_id) }}">Payment Accepted</a>
                 <a class="btn btn-danger" href="{{ url('cancel_orders/'.$order_tbl->order_id) }}">Cancel Order</a>
                @endif
              </div>
              <!-- end custombox -->
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
              <div class="custom-box">
                ...
                <ul class="pricing">
                  ...
                  <li>Status  : <span class="badge badge-warning">Pending</span></li>
        ...
        <!--  /row -->
            ...
            <h3 style="float: left;">New Pending Orders</h3>
